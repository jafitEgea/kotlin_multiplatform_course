    ...
    when (uiState) {
            ...
            if (uiState.expenses.isEmpty()) {
                Box(
                    ...
                    Text(
                        ...
                        text = "No expenses found, please add a new one expense tapping the + symbol down bellow",
                ...
                LazyColumn(
                    ...
                    items(items = uiState.expenses, key = { it.id }) { expense ->
                        SwipeToDeleteContainer(
                            item = expense, onDelete = onDeleteExpense
                        ) {
        ...
        is ExpenseUiState.Error -> {
            Box(
                ...
                Text(
                    "Error: ${uiState.message}", style = MaterialTheme.typography.body1
                )
            }
